  ...
  render() {
    return (
      <div>
        ...
        <p>
          I am a full stack web developer, I have just graduated from a great
          boot camp called DevMountain located in Dallas, TX. Learning
          responsive frameworks, databases, and best code practice.
          <br />
